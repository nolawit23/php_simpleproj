...
<div class="wrapper row2">
  <div class="rounded">
   ...
   <li> <a href="checkitem.php"  target="content">Check Item</a></li>
...
<div id="centerrrr">
	...
	<iframe  src="managerwellcome.php" name="content" width="880px" height="700px" frameBorder="0" scrolling="yes" style="">
</iframe>
</div>	<br/><br/><br/>
...
?>
	<a  href="updateprofilem.php" target="content"><font size="4" color="#1E90FF">Update Profile</font></a>
<br />
