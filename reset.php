...
// Insert Temp Table
mysqli_query($con,
"INSERT INTO `resetpass` (`username`, `key`, `expDate`)
...
?>
<form method="post" action="resetpass.php" name="reset"><br /><br />
<label><strong>Enter Your name of user:</strong></label><br /><br />
<input type="username" name="username" placeholder="Enter user name" />
<br /><br />
