...
<form id="form1" name="login" method="POST" action="searchdrugs.php" onsubmit="return formValidation()">
  	
<p style="font-size:20px;color:#000000;" >View Drug Item</p>
   <table width="399px" valign="top" align="center">
   <tr>

<td class='para1_text' width="220px"><font color="red">*</font> 
<label>pharmacy name</label>
  ...
  <tr>
	       ...
	       <td class='para1_text' width="220px"><font color="red">*</font> 
           Drug Name.</td><td><input type="text" name="id" id="user" x-moz-errormessage="Enter office name." ></td>
...
<!--Php Script-->  
	...
	if($id=="")
	{
		echo '<p class="wrong"> please enter drug name or pharmacy to search</p>';
	}	
	else{
	
			$view=mysqli_query($con,"select * from drug where drug_name='$id' and pharmacy='$pharmacy'");
...
else
{
    ...
    echo"<td><font face='Times New Roman' size='4' color='white'>Company:</td><td>".$company.'</td></tr>';
    echo"<td><font face='Times New Roman' size='4' color='white'>Drug brand:</td><td>".$drugbrand.'</td></tr>';
    echo"<td><font face='Times New Roman' size='4' color='white'>Pharmacy:</td><td>".$pharmacy.'</td></tr>';
